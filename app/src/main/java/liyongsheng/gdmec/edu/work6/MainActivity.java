package liyongsheng.gdmec.edu.work6;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,SurfaceHolder.Callback {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == MENU_START) {
            ...
            Intent intent = new Intent(this, liyongsheng.gdmec.edu.work6.AlbumActivity.class);
    ...
    public void saveAndShow(byte[] data){
        try
        {
            ...
            fos.write(data);
            fos.close();
            liyongsheng.gdmec.edu.work6.AlbumActivity album = new liyongsheng.gdmec.edu.work6.AlbumActivity();
            //读取相片Bitmap
